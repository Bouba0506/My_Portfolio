...
const Hero = () => {
  return (
    <section id="hero" className="mt-28 md:flex items-center text-white md:px-16 px-8 gap-10 w-full ">
      {/* left side */}
      <div className="md:w-1/2  flex flex-col text-3xl font-bold justify-center">
        ...
        <div className="flex items-center mt-6 space-x-4">
          ...
          <a href="#"className="w-6 h-6 bg-[#9b061c] hover:scale-125 transition-all duration-300 rounded-full flex items-center justify-center">
          ...
          <button className="bg-[#9b061c] rounded-lg flex items-center text-xl p-2 justify-center">Contact Me</button>
        </div>
        {/* Experience */}
      ...
      <img src={blue} alt="portfolio" className="w-full h-96 object-contain"/>
      </div>
    </section >
  );
};
